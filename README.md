...
- 🌱 I’m currently preparing for Backstage, OpenTelemetry and Kyverno certifications to become an CNCF Golden Kubestronaut.
- I'm interested in Agentic AI.
- Ask me about anything related to cloud ☁️ (AWS, GCP, Azure), Docker 🐳, Kubernetes ☸️, Cilium, Istio, Python 🐍, Ansible, Terraform, Linux 🐧, Shell scripting, Git, GitHub Actions, Prometheus, GitOps, Argo.
