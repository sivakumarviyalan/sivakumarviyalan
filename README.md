...
- Ask me about anything related to cloud (AWS, GCP, Azure), Docker, Podman, Kubernetes, OpenShift, Cilium, Istio, Python, Ansible, Terraform, Linux, Shell scripting, Git, GitHub Actions, Prometheus, GitOps, Argo.
